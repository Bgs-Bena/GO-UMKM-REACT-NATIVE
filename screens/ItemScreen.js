    ...
    <SafeAreaView className="flex-1 bg-white relative">
      <ScrollView className="flex-1 px-4 py-6">
        <View className="relative bg-white shadow-lg">
          ...
          <View className="px-1 py-1 rounded-md bg-teal-100">
        ...
        <View className=" space-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2">
          ...
          <View style={{ width: 200, height: 100, justifyContent: "center", marginBottom: 12}}>
              <TouchableOpacity
              onPress={() => navigation.navigate("MapsScreen")}
              style={{ bottom: 10, width: 350, height: 50, borderWidth: 1, borderColor: "#00BCC9", borderRadius: 12, alignItems: "center", justifyContent: "center" }}
            >
                <Text style={{ fontSize: 24, fontWeight: "bold", textTransform: "uppercase", letterSpacing: 1, color: "green"}}>Location</Text>
            </TouchableOpacity>
          </View>
        </View>
